...
<body>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#about">Eventos</a></li>
          <li><a class="nav-link scrollto " href="#portfolio">Videos e Fotos</a></li>
          <!--<li><a class="nav-link scrollto" href="#services">Ofertas e Dízimos</a></li> -->
          <li><a class="nav-link scrollto" href="#team">Palavra Pastoral</a></li>
          <li class="dropdown"><a href="#"><span>Grupos e Conselhos</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li class="dropdown"><a href="#"><span>Conselhos</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
      ...
      <a href="#about" class="get-started-btn scrollto">Área do Membro</a>
    </div>
  </header><!-- End Header -->
  ...
  <section id="hero" class="d-flex align-items-center position-relative">
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        ...
        <div class="carousel-item">
          <img src="assets/img/hero-bg.webp" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="assets/img/hero-bg.jpg" class="d-block w-100" alt="...">
        </div>
    ...
    <!-- <div class="container position-absolute top-50 start-50 translate-middle" data-aos="zoom-out" data-aos-delay="100">
      <div class="row">
        <div class="col-xl-6">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              <li data-filter="*" class="filter-active">Eventos</li>
              <li data-filter=".filter-app">Grupos</li>
              <li data-filter=".filter-card">Conselhos</li>
              <li data-filter=".filter-web">Evangelismo</li>
            </ul>
          </div>
        </div>
